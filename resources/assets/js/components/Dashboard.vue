<template>
    <div class="container">
        <div class="columns">
            <div id="dashboard-categories-menu" class="column is-2 dashboard-categories-menu">
                ...
                <div class="dashboard-categories" @mouseenter.native="updateScrollbar('menuScrollbar')">
                    ...
                    <div class="scroll-area" ref="menuScrollbar">
                        ...
                        <menu-category @expand="expandList" @select="select($event)" v-for="category in categories"
                            :key="category.id" :data="category" :selected="selected"
                            :parent-name="category.name"></menu-category>
                    </div>
                </div>
            ...
            <div class="column dashboard-main">
                <div v-show="width > 738" class="dashboard-search" :class="{ focus: focus }">
                    ...
                    <span class="fa fa-times-circle clear-search" v-if="queryString"
                        @click="queryString = ''; search()"></span>
                ...
                <div class="dashboard-files">
                    ...
                    <div class="files-container" ref="mainScrollbar" @mouseenter.native="updateScrollbar('mainScrollbar')"
                        infinite-wrapper>
                        ...
                        <div v-if="width <= 880 && width > 450" class="columns files-row medium">
                            ...
                            <div class="column files-column">
                                ...
                                <file-item ref="mainfiles" v-if="index % 2 === 0" v-for="(file, index) in files"
                                    :key="file.id" :ind="index" :data="file"
                                    @select="$store.commit('dashboard/selectFile', file)"
                                    @deselect="$store.commit('dashboard/deselectFile', file)"></file-item>
                            ...
                            <div class="column files-column">
                                ...
                                <file-item ref="mainfiles" v-if="index % 2 === 1" v-for="(file, index) in files"
                                    :key="file.id" :ind="index" :data="file"
                                    @select="$store.commit('dashboard/selectFile', file)"
                                    @deselect="$store.commit('dashboard/deselectFile', file)"></file-item>
                        ...
                        <div v-if="width <= 450" class="columns files-row small">
                            ...
                            <div class="column files-column">
                                ...
                                <file-item ref="mainfiles" v-for="(file, index) in files" :key="file.id" :data="file"
                                    @select="$store.commit('dashboard/selectFile', file)"
                                    @deselect="$store.commit('dashboard/deselectFile', file)"></file-item>
        ...
        <transition-group name="fade" mode="out-in">
            <modal-add-header v-if="modals.addHeader.show" @delete="$store.commit('dashboard/openModal', 'deleteHeader')"
                @close="$store.commit('dashboard/closeModal', 'addHeader')" :key="'addHeader'"></modal-add-header>
            <modal-add-footer v-if="modals.addFooter.show" @delete="$store.commit('dashboard/openModal', 'deleteFooter')"
                @close="$store.commit('dashboard/closeModal', 'addFooter')" :key="'addFooter'"></modal-add-footer>
            <modal-add-cover v-if="modals.addCover.show" @delete="$store.commit('dashboard/openModal', 'deleteCover')"
                @close="$store.commit('dashboard/closeModal', 'addCover')" :key="'addCover'"></modal-add-cover>
            <modal-add-operation v-if="modals.addOperation.show"
                @delete="$store.commit('dashboard/openModal', 'deleteOperation')"
                @close="$store.commit('dashboard/closeModal', 'addOperation')" :key="'addOperation'"></modal-add-operation>
            <modal-add-divider v-if="modals.addDivider.show" @close="$store.commit('dashboard/closeModal', 'addDivider')"
                :key="'addDiv'"></modal-add-divider>
            <modal-upload-file-dashboard v-if="modals.uploadFileDashboard.show"
                @close="$store.commit('dashboard/closeModal', 'uploadFileDashboard')" :width="this.width"
                :key="'uploadFile'"></modal-upload-file-dashboard>
            ...
            <modal-delete-footer v-if="modals.deleteFooter" @save="$store.commit('dashboard/deleteHFC', 'addFooter')"
                @close="$store.commit('dashboard/closeModal', 'deleteFooter')" :key="'delFooter'"></modal-delete-footer>
            <modal-delete-cover v-if="modals.deleteCover" @save="$store.commit('dashboard/deleteHFC', 'addCover')"
                @close="$store.commit('dashboard/closeModal', 'deleteCover')" :key="'delCover'"></modal-delete-cover>
            <modal-delete-operation v-if="modals.deleteOperation"
                @save="$store.commit('dashboard/deleteHFC', 'addOperation')"
                @close="$store.commit('dashboard/closeModal', 'deleteOperation')"
                :key="'delOperation'"></modal-delete-operation>
            <modal-remove-item v-if="modals.removeItem" @save="removeItem"
                @close="$store.commit('dashboard/closeModal', 'removeItem')" :key="'removeItem'"></modal-remove-item>
            <modal-remove-items v-if="modals.removeItems" @save="removeItems"
                @close="$store.commit('dashboard/closeModal', 'removeItems')" :key="'removeItems'"></modal-remove-items>
            <modal-start-over v-if="modals.startOver" @save="startOver"
                @close="$store.commit('dashboard/closeModal', 'startOver')" :key="'startOver'"></modal-start-over>
        </transition-group>
    </div>
</template>
<script>
